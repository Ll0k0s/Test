...
extern void notifyUserPacket(uint8_t *data);

extern void notifySensor( uint16_t Address, bool State ) __attribute__ ((weak));
...
extern void notifySwitchRequest( uint16_t Address, bool Output, bool Direction ) __attribute__ ((weak));
